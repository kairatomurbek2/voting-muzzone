# Generated by Django 2.0.5 on 2018-05-18 06:59

from django.db import migrations, models
import django.db.models.deletion
import main.image_utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now=True, verbose_name='Дата создание')),
            ],
            options={
                'verbose_name': 'Опрос',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_address', models.GenericIPAddressField(verbose_name='Ip адресс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=main.image_utils.poll_choices_image_path, verbose_name='Изображение')),
